...
exports.addAd = async (req, res, next) => {
  ...
  try {
    ...
    console.log(err);
    res.status(500).json({ errors: [{ msg: 'Server error in adjs' }] });
  }
};
...
exports.updateAd = async (req, res, next) => {
  ...
  try {
    ...
    console.log(err);
    res.status(500).json({ errors: [{ msg: 'Server error in here' }] });
  }
 // console.log(adId);
};
...
exports.deleteAd = async (req, res, next) => {
  ...
  try {
    ...
    console.log(err);
    res.status(500).json({ errors: [{ msg: 'Server error in  addel' }] });
  }
};
